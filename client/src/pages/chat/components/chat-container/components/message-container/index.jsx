...
const MessageContainer = () => {
    ...
    const { selectedChatType, selectedChatData, selectedChatMessages, userInfo, setSelectedChatMessages, setFileDownloadProgress, setIsDownloading } = useAppStore();
                ...
                >
                    {checkIfImage(message.fileUrl) ? (
                        ...
                        <div className="flex items-center justify-center gap-5">
                            ...
                            <span className="bg-[#4c64a6] p-3 text-2xl rounded-full hover:bg-[#151f38] cursor-pointer transition-all duration-300" onClick={() => downloadFile(message.fileUrl)}>
                                <IoMdArrowRoundDown />
                            </span>
                        </div>
                    )}
            ...
            )}
            {
                message.sender._id !== userInfo.id ? (
                    <div className="flex items-center justify-start gap-3">
                        <Avatar className="h-8 w-8 rounded-full overflow-hidden border-2 border-gray-700">
            ...
            {showImage && (
                <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col">
                    ...
                    <div className="flex gap-5 fixed top-0 mt-5">
                        <button className="bg-[#4c64a6] p-3 text-2xl rounded-full hover:bg-[#151f38] cursor-pointer transition-all duration-300" onClick={() => downloadFile(imageURL)}>
                            <IoMdArrowRoundDown />
                        </button>
                        <button className="bg-[#4c64a6] p-3 text-2xl rounded-full hover:bg-[#151f38] cursor-pointer transition-all duration-300" onClick={() => { setShowImage(false); setImageURL(null); }}>
                            <IoCloseSharp />
                        </button>
                    </div>
                </div>
